...
import {
  ...
  MessageSquare, QrCode, Settings, ScrollText,
  Globe, Layers, CreditCard, UserPlus, Shield, Download, Gift, Wine
} from 'lucide-react';
...
const navGroups = [
  ...
  },
  {
    ...
    items: [
      ...
      { key: 'nav.forfaits', path: '/forfaits', icon: Gift, roles: ['admin','manager','receptionist'] },
    ],
  },
  {
    label: 'Gestion',
    items: [
      ...
      { key: 'nav.export', path: '/export', icon: Download, roles: ['admin','manager'] },
    ],
  },
  {
    label: 'Configuration',
